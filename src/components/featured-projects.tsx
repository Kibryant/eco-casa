...
const featuredProjects = [
  {
    id: 1,
    title: "Pétra",
    description: "O Pétra é um empreendimento projetado pela Construtora Almeida Carneiro com foco na integração entre arquitetura, funcionalidade e paisagem. Localizado à beira-mar, o projeto combina técnicas arquitetônicas e materiais pensados para proporcionar conforto e elegância aos moradores.",
    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          >
            <span className="text-primary font-medium mb-4 block">DESTAQUES</span>
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">Projetos em Destaque</h2>
            <p className="text-muted-foreground max-w-xl">
              Conheça alguns dos nossos projetos mais recentes e impactantes, onde combinamos sustentabilidade, design e
              funcionalidade.
            </p>
          </motion.div>
        </div>
