...
import { Lightbulb, Award, BadgeIcon as Certificate, Palette } from "lucide-react"

const features = [
  {
    icon: Lightbulb,
    title: "Inovação Sustentável",
    description: "Transformamos recursos naturais em soluções ecológicas, valorizando o ambiente.",
  },
  {
    icon: Award,
    title: "Desempenho Excepcional",
    description: "Beleza natural aliada a requisitos funcionais, garantindo durabilidade.",
  },
  {
    icon: Certificate,
    title: "Certificações Internacionais",
    description: "Compromisso global com as melhores práticas do setor e normas ambientais.",
  },
  {
    icon: Palette,
    title: "Variedade de Design",
    description: "Ampla oferta de designs, acabamentos e cores para personalizar projetos.",
  },
]

const projects = [
  {
    title: "Residencial Marina Bay",
    image: "/placeholder.svg?height=400&width=600",
    category: "Residencial",
  },
  {
    title: "Club House Resort",
    image: "/placeholder.svg?height=400&width=600",
    category: "Comercial",
  },
  {
  ...
  return (
    <section className="py-24">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
            <span className="text-primary font-medium mb-4 block">DIFERENCIAIS ECO CASA</span>
            ...
            {features.map((feature) => (
              ...
              >
                ...
                <div className="relative mb-6 flex justify-center items-center">
                  <div
                    className="relative w-14 h-14 flex items-center justify-center rounded-full bg-primary/10 transition-colors duration-300"
                  >
                    <feature.icon
                ...
                <h3 className="font-display text-xl font-semibold mb-3 relative z-10">{feature.title}</h3>
        ...
        <motion.div
          ...
          className="mt-32"
        >
          <span className="text-primary font-medium mb-4 block">ÚLTIMOS TRABALHOS</span>
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12">
            ...
            <p className="text-foreground/70 max-w-xl">
              Explore nossa galeria de realizações recentes, onde cada projeto é um testemunho da excelência Lesco. Uma
              coleção diversificada de transformações que se tornaram listas em ambientes extraordinários. Descubra o
              poder da Lesco em nossos últimos trabalhos.
            </p>
          </div>
